          ...
          #Check to ensure cell neighbor is not medium or other cell types
            ...
            #sum up common surface area of cell with its neighbors
                ...
                if  randint(1,ECapoptosisratevariable)==1:
                    cell.type=6
                    Apoptotic = 1
                if totalArea<26 and VEGFconcentration>0.4:      #VEGFR2 inhibition - takes twice as much VEGF to instigate growth (control:0.4)               
                    if CXCL10concentration>0.3:
                        if CXCL10concentration>0.6:
                            ...
                            if VEGFconcentration>1:
                                ...
                                cell.targetVolume+=0.4 #EC proliferation, control is 0.8
                                cell.targetSurface=4*sqrt(cell.targetVolume)
            ...
            if cell.type==2:
                ...
                cell.targetVolume+=(0.005*randommultiplier)   #Inflammatory Cell Proliferation control=0.02
                cell.targetSurface=4*sqrt(cell.targetVolume)
		...
		cell.targetSurface=4*sqrt(cell.targetVolume)           
          ...
          # #Check to ensure cell neighbor is not medium or other cell types
            ...
            #sum up common surface area of cell with its neighbors
                ...
                if totalECArea>5:                                  
                    cell.targetVolume+=(0.01*randommultiplier)  #Mural Cell Proliferation control=0.04
                    cell.targetSurface=4*sqrt(cell.targetVolume)
